...
export default class AltitudeSports extends Merchant {
  constructor(url) {
    super(url);
  }
  ...
  scrapeMulti(element) {
    ...
    try {
      // Product Name
      let productName = element.querySelector('.ss-product__info__name');
      if (productName) {
        result['productName'] = productName.textContent.trim();
      }

      // Brand Name
      let brandName = element.querySelector('.ss-product__info__manufacturer');
      if (brandName) {
