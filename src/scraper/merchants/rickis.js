...
export default class Rickis extends Merchant {
  constructor(url) {
    super(url);
  }
  ...
  scrapeMulti(element) {
    ...
    try {
      ...
      // Prices
      let price = element.querySelector('.product-standard-price');
      let salePrice = element.querySelector('.product-sales-price');
