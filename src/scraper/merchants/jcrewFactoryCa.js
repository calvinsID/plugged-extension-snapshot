...
export default class JcrewFactoryCa extends Merchant {
  constructor(url) {
    super(url);
  }
  ...
  scrapeMulti(element) {
    ...
    try {
      ...
      // Prices
      let retailPrice = element.querySelector('.tile__detail--fc-was-price > .has-strikethrough');
      let currentPrice = element.querySelector('.tile__detail--fc-now-price > .now-price');
